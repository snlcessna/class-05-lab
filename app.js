...
function sumArray(thisArray) {
  ...
  return [sum, thisArray[0] + ',' + thisArray[1] +  ',' + thisArray[2] + ' was passed in as an array of numbers, and ' + sum + ' is their sum.'];
}
...
// Write your code here
function multiplyArray(anotherArray) {
  var product = 1;

  for (var i = 0; i < anotherArray.length; i++) {
    product*=anotherArray[i];
  }
  return [product, 'The numbers ' + anotherArray[0] + ',' + anotherArray[1] +  ',' + anotherArray[2] + ' have a product of ' + product + '.'];
}
